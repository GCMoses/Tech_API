...
public record ProductCreateDTO(string Category);/*, IEnumerable<GamingHeadphonesAndHeadsetCreateDTO>? GamingHeadphonesAndHeadset/*, IEnumerable<GamingMouseCreateDTO>? GamingMouse*/
//{
